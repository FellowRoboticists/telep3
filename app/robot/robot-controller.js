...
router.get(
  ...
  function __getRobotList (req, res, next) {
...
router.get(
  ...
  tokenMW.processJWTToken,
  tokenMW.verifyAuthenticated,
  function __checkIfRobotConnected (req, res, next) {
...
router.post(
  ...
  tokenMW.processJWTToken,
  tokenMW.verifyAuthenticated,
  function __createRobot (req, res, next) {
...
router.put(
  ...
  tokenMW.processJWTToken,
  tokenMW.verifyAuthenticated,
  function __updateRobot (req, res, next) {
...
router.put(
  ...
  tokenMW.processJWTToken,
  tokenMW.verifyAuthenticated,
  function __startRobotTube (req, res, next) {
...
router.put(
  ...
  tokenMW.processJWTToken,
  tokenMW.verifyAuthenticated,
  function __controlRobot (req, res, next) {
...
router.delete(
  ...
  tokenMW.processJWTToken,
  tokenMW.verifyAuthenticated,
  function __deleteRobot (req, res, next) {
